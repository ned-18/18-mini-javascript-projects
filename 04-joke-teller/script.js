...
function tellMe(joke) {
    VoiceRSS.speech({
        key: 'e82930b78a8c46edb0de2c38c40e5854',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
// Share Jokes 
function shareJokeOnTwitter() {
    const someJoke = textJoke.innerText;
    const twitterUrl = `https://twitter.com/intent/tweet?text=${someJoke}`;
...
copyBtn.addEventListener('click', copyToClipboard.bind(this, textJoke));
twitterBtn.addEventListener('click', shareJokeOnTwitter);